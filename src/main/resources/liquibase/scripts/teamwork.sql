...
ALTER TABLE animal_shelter ADD COLUMN photo BIGINT REFERENCES photo(id);

-- changeset karybekov:2
ALTER TABLE animal_shelter DROP COLUMN photo;
ALTER TABLE animal_shelter ADD COLUMN photo_id BIGINT REFERENCES photo(id);
